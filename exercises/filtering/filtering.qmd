...
The first result is Julian Reese who had a trueshooting percentage of 60.75 (slightly above Ja'Kobi Gillespie who took tougher shots from further away)
...
matches_2024 |>
  filter(team == 'Maryland Terrapins, Terps', date < "2024-09-02") |>
  group_by(team) |>
  summarise(
    total_attempts = sum(sh_att),
    total_on_goal = sum(so_g),
...
Maryland's shot on goal percentage this season is significantly higher than it was last year, increasing nearly seven percent. After only having a 47.69 shot on goal percentage in 2024, the Terps, through the first seven games, have 46 shots on goal on 85 total shots for a shot on goal percentage of 54.11. However, as we talked about in class, I would be curious to see the percentage of goals they've scored on their shots on goal from the first seven games last season. That is a more honest assessment to see if they have actually improved offensively.