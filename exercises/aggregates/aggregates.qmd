...
```
**Answer** The first thing I noticed is that the New York Knicks starting lineup is among the top players in the NBA in terms of minutes played. Mikal Bridges is the top player by nearly 200 minutes and the Knicks have three players in the top 10 with their starting five all within the top 40. However, that was not surprising given how little the Knicks used their bench last season. However, something that I found shocking is the number of role players who played more minutes than stars. I didn't expect to see guys like Christian Braun, Ivica Zubac, Jaden McDaniels and Keegan Murray ahead of Shai Gilgeous-Alexander, who was last season's MVP. I also see a lot of duplicate players, just the ones who were traded at the deadline. 
...
**Answer** I am curious how they classify shooting guards versus all the other positions. Having 52 more shooting guards than the next closest position (small forward) is quite a large difference. Some players who I would view as point guards or small forwards are listed as shooting guards, which makes me question the validity of the totals listed above. The othere four positions are all within five of each other, a way more reasonable gap.
...
**Answer** As I mentioned above, the number of shooting guards is significantly more than the rest of the positions so it feels like that is the default answer for someone who can play anything between the point guard and small forward range. Scrolling through the players listed, I see a lot of duplicates for shooting guards so maybe the number of shooting guards traded at the deadline was significantly more than the rest, which would explain the giant gap.
...
**ANSWER** The biggest storyline to me is the heavy volume of minutes that point guards play compared to the rest of the positions. The average is 28 minutes more than the next closest position. It makes sense that point guards play more than power forwards and centers but I wouldn't expect it to be that much more than shooting guards and small forwards. I think a story about the durability of point guards would be interesting, maybe their training is different than the rest of the players. 