...
```{r load-data}
coaching <- read_csv("https://raw.githubusercontent.com/dwillis/wbb/refs/heads/master/ncaa/coaching_histories_merged.csv")
...
hc_production_schools <- future_hc_positions |>
  filter(before_hc, division == "I") |>  # MODIFY THIS LINE IF NEEDED
...
MIN_OVERLAP_YEARS <- 0  # CHANGE THIS (0 = any overlap, 1, 2, 3 for stricter definition)
